    ...
    <div className='pt-[85px] pb-[90px] md:pt-[75px] md:mt-[20px] md:px-0 bg-[#fff] dark:bg-gray-900 dark:text-gray-100 md:bg-[#f9f9f9]'>
      ...
      <div className='bg-[#fff] dark:bg-gray-800 dark:border-gray-700 lg:w-[60%] md:w-[80%] md:mx-auto md:border md:border-[#a3a3a3a3] md:border-solid md:rounded-[10px] md:shadow-[rgba(0,0,0,0.24)_0px_3px_8px] md:overflow-hidden md:p-[20px]'>
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          >
            <div className='flex-1 line-clamp-1'>
              ...
              <input
                ...
                placeholder=''
                readOnly
                className='bg-transparent text-[18px] md:text-[14px] w-full cursor-pointer outline-none dark:placeholder-gray-400'
              />
            </div>
          ...
          {/* Các input khác — cùng pattern dark mode */}
          {[
            { name: "detailAddress", label: "Địa chỉ chi tiết", placeholder: "Vd: tên tòa nhà / địa điểm gần đó" },
            { name: "note", label: "Ghi chú cho tài xế", placeholder: "Chỉ dẫn chi tiết địa điểm cho tài xế" },
            { name: "contactName", label: "Tên người liên lạc", placeholder: "" },
            { name: "contactPhonenumber", label: "Số điện thoại liên lạc", placeholder: "" },
          ].map((field) => (
            <div
              key={field.name}
