...
const page = () => {
  ...
  return (
    <div className='bg-[#fff] md:bg-[#f9f9f9] md:pt-[110px] dark:bg-gray-900 dark:text-gray-100'>
      <Heading title='Đăng nhập' description='' keywords='' />
      <div className='hidden md:block'>
        <Header />
      </div>

      <div className='bg-[#fff] dark:bg-gray-800 lg:w-[60%] md:w-[90%] md:mx-auto md:border md:border-[#a3a3a3a3] md:dark:border-gray-700 md:border-solid md:rounded-[10px] md:shadow-[rgba(0,0,0,0.24)_0px_3px_8px] md:overflow-hidden'>
        <div className='flex flex-col items-center justify-between py-[30px] h-screen md:h-full'>
          <div className='flex flex-col items-center w-full'>
            <h3 className='text-[#4A4B4D] dark:text-gray-100 text-[30px] font-bold pb-[20px]'>Đăng nhập</h3>
            ...
            <form onSubmit={formik.handleSubmit} className='flex flex-col items-center w-full'>
              ...
              <div className='w-[90%] my-[10px]'>
                <div
                  className={`relative flex items-center bg-[#f5f5f5] dark:bg-gray-700 text-[#636464] dark:text-gray-200 rounded-[12px] gap-[8px] border border-solid overflow-hidden ${
            ...
            <Link
              ...
              className='text-[#636464] dark:text-gray-300 font-semibold my-[10px] cursor-pointer'
            >
              Quên mật khẩu?
            </Link>
              ...
              <GoogleOAuthProvider clientId={process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID}>
                <GoogleLogin
                  onSuccess={async (credentialResponse) => {
                    ...
                    if (!token) return toast.error("Không lấy được token từ Google");
                    try {
          ...
          <p className='text-[#636464] dark:text-gray-300 font-semibold mt-[20px]'>
            Chưa có tài khoản?{" "}
            <Link href='/auth/register' className='text-[#fc6011] dark:text-orange-400 cursor-pointer'>
              Đăng ký
            </Link>
          </p>
        </div>
