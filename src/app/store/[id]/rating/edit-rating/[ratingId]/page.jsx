    ...
    <div className='px-4 md:pt-[110px] pb-[100px] bg-white dark:bg-gray-900 dark:text-gray-100 transition-colors duration-300'>
      ...
      <div className='bg-white dark:bg-gray-800 dark:border dark:border-gray-700 lg:w-[60%] md:w-[80%] md:mx-auto rounded-xl shadow-md dark:shadow-gray-900 p-4 md:p-6 transition-colors'>
        ...
        <div className='text-center mt-6 space-y-2'>
          <span className='text-[#4A4B4D] dark:text-gray-100 text-2xl font-semibold'>Chỉnh sửa đánh giá bữa ăn</span>
          {detailRating && (
            <p className='text-gray-600 dark:text-gray-300 text-lg'>
              Bạn thấy món ăn từ{" "}
              <span className='font-bold text-[#fc6011] dark:text-orange-400'>{detailRating.store.name}</span> như thế
              nào?
            </p>
          )}
        </div>
